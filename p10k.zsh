# Generated by Powerlevel10k configuration wizard on 2020-08-07 at 18:26 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%K{white} %k%F{white}\uE0B0%f'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%K{yellow} %F{black}$%f %k%F{yellow}\uE0B0%f'
